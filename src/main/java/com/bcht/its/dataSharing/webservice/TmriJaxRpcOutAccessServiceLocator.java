...
public class TmriJaxRpcOutAccessServiceLocator extends org.apache.axis.client.Service implements com.bcht.its.dataSharing.webservice.TmriJaxRpcOutAccessService {
    ...
    private java.lang.String TmriOutAccess_address = "http://10.160.118.40/trffweb/services/TmriOutAccess";
    ...
    public com.bcht.its.dataSharing.webservice.TmriJaxRpcOutAccess getTmriOutAccess(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bcht.its.dataSharing.webservice.TmriOutAccessSoapBindingStub _stub = new com.bcht.its.dataSharing.webservice.TmriOutAccessSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bcht.its.dataSharing.webservice.TmriJaxRpcOutAccess.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bcht.its.dataSharing.webservice.TmriOutAccessSoapBindingStub _stub = new com.bcht.its.dataSharing.webservice.TmriOutAccessSoapBindingStub(new java.net.URL(TmriOutAccess_address), this);
                _stub.setPortName(getTmriOutAccessWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://10.160.118.40/trffweb/services/TmriOutAccess", "TmriJaxRpcOutAccessService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://10.160.118.40/trffweb/services/TmriOutAccess", "TmriOutAccess"));
        }
